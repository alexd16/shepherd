...
function t(a,b,c){c=c||{};c.arrayMerge=c.arrayMerge||da;c.isMergeableObject=c.isMergeableObject||aa;c.cloneUnlessOtherwiseSpecified=ca;var d=Array.isArray(b),e=Array.isArray(a);return d!==e?ca(b,c):d?c.arrayMerge(a,b,c):ia(a,b,c)}t.all=function(a,b){if(!Array.isArray(a))throw Error("first argument should be an array");return a.reduce(function(a,d){return t(a,d,b)},{})};var ka=t;function u(a){return"function"===typeof a}function la(a){return"string"===typeof a}
...
function Ba(a){for(var b=w(a),c=Aa(a);c&&0<=["table","td","th"].indexOf(z(c))&&"static"===getComputedStyle(c).position;)c=Aa(c);if(c&&"body"===z(c)&&"static"===getComputedStyle(c).position)return b;if(!c)a:{for(a=xa(a);y(a)&&0>["html","body"].indexOf(z(a));)if(c=getComputedStyle(a),"none"!==c.transform||"none"!==c.perspective||c.willChange&&"auto"!==c.willChange){c=a;break a}else a=a.parentNode;c=null}return c||b}
...
function Ma(a,b){if("viewport"===b){b=w(a);var c=A(a);b=b.visualViewport;var d=c.clientWidth;c=c.clientHeight;var e=0,f=0;b&&(d=b.width,c=b.height,/^((?!chrome|android).)*safari/i.test(navigator.userAgent)||(e=b.offsetLeft,f=b.offsetTop));a={width:d,height:c,x:e+ta(a),y:f};a=La(a)}else y(b)?(a=qa(b),a.top+=b.clientTop,a.left+=b.clientLeft,a.bottom=a.top+b.clientHeight,a.right=a.left+b.clientWidth,a.width=b.clientWidth,a.height=b.clientHeight,a.x=a.left,a.y=a.top):(f=A(a),a=A(f),e=ra(f),b=f.ownerDocument.body,
...
function Ta(a,b){void 0===b&&(b={});var c=b;b=c.placement;b=void 0===b?a.placement:b;var d=c.boundary,e=void 0===d?"clippingParents":d;d=c.rootBoundary;var f=void 0===d?"viewport":d;d=c.elementContext;d=void 0===d?"popper":d;var h=c.altBoundary,m=void 0===h?!1:h;c=c.padding;c=void 0===c?0:c;c=Ra("number"!==typeof c?c:Sa(c,Ca));var k=a.elements.reference;h=a.rects.popper;m=a.elements[m?"popper"===d?"reference":"popper":d];e=Oa(sa(m)?m:m.contextElement||A(a.elements.popper),e,f);f=qa(k);m=Qa({reference:f,
element:h,strategy:"absolute",placement:b});h=La(Object.assign(Object.assign({},h),m));f="popper"===d?h:f;var g={top:e.top-f.top+c.top,bottom:f.bottom-e.bottom+c.bottom,left:e.left-f.left+c.left,right:f.right-e.right+c.right};a=a.modifiersData.offset;if("popper"===d&&a){var l=a[b];Object.keys(g).forEach(function(a){var b=0<=["right","bottom"].indexOf(a)?1:-1,c=0<=[top,"bottom"].indexOf(a)?"y":"x";g[a]+=l[c]*b})}return g}var Ua={placement:"bottom",modifiers:[],strategy:"absolute"};
...
Ua),d),modifiersData:{},elements:{reference:a,popper:b},attributes:{},styles:{}},l=[],n=!1,q={state:g,setOptions:function(h){f();g.options=Object.assign(Object.assign(Object.assign({},d),g.options),h);g.scrollParents={reference:sa(a)?za(a):a.contextElement?za(a.contextElement):[],popper:za(b)};h=Ha(Ja([].concat(c,g.options.modifiers)));g.orderedModifiers=h.filter(function(a){return a.enabled});e();return q.update()},forceUpdate:function(){if(!n){var a=g.elements,b=a.reference;a=a.popper;if(Va(b,a))for(g.rects=
{reference:va(b,Ba(a),"fixed"===g.options.strategy),popper:wa(a)},g.reset=!1,g.placement=g.options.placement,g.orderedModifiers.forEach(function(a){return g.modifiersData[a.name]=Object.assign({},a.data)}),b=0;b<g.orderedModifiers.length;b++)if(!0===g.reset)g.reset=!1,b=-1;else{var c=g.orderedModifiers[b];a=c.fn;var d=c.options;d=void 0===d?{}:d;c=c.name;"function"===typeof a&&(g=a({state:g,options:d,name:c,instance:q})||g)}}},update:Ia(function(){return new Promise(function(a){q.forceUpdate();a(g)})}),
destroy:function(){f();n=!0}};if(!Va(a,b))return q;q.setOptions(h).then(function(a){if(!n&&h.onFirstUpdate)h.onFirstUpdate(a)});return q}}({defaultModifiers:[{name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:function(a){var b=a.state,c=a.instance;a=a.options;var d=a.scroll,e=void 0===d?!0:d;a=a.resize;var f=void 0===a?!0:a,h=w(b.elements.popper),m=[].concat(b.scrollParents.reference,b.scrollParents.popper);e&&m.forEach(function(a){a.addEventListener("scroll",c.update,Wa)});f&&
h.addEventListener("resize",c.update,Wa);return function(){e&&m.forEach(function(a){a.removeEventListener("scroll",c.update,Wa)});f&&h.removeEventListener("resize",c.update,Wa)}},data:{}},{name:"popperOffsets",enabled:!0,phase:"read",fn:function(a){var b=a.state;b.modifiersData[a.name]=Qa({reference:b.rects.reference,element:b.rects.popper,strategy:"absolute",placement:b.placement})},data:{}},{name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:function(a){var b=a.state,c=a.options;a=c.gpuAcceleration;
...
a),Object.keys(f).forEach(function(a){d.removeAttribute(a)}))})}},requires:["computeStyles"]},{name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:function(a){var b=a.state,c=a.name;a=a.options.offset;var d=void 0===a?[0,0]:a;a=Ea.reduce(function(a,c){var e=b.rects;var f=B(c);var h=0<=["left",top].indexOf(f)?-1:1,m="function"===typeof d?d(Object.assign(Object.assign({},e),{},{placement:c})):d;e=m[0];m=m[1];e=e||0;m=(m||0)*h;f=0<=["left","right"].indexOf(f)?{x:m,y:e}:{x:e,y:m};a[c]=
...
c=b.options.placement;l=B(c);f=f||(l!==c&&n?db(c):[$a(c)]);var r=[c].concat(f).reduce(function(a,c){return a.concat("auto"===B(c)?cb(b,{placement:c,boundary:m,rootBoundary:k,padding:h,flipVariations:n,allowedAutoPlacements:q}):c)},[]);c=b.rects.reference;f=b.rects.popper;var p=new Map;l=!0;for(var v=r[0],H=0;H<r.length;H++){var x=r[H],ja=B(x),E="start"===x.split("-")[1],F=0<=[top,"bottom"].indexOf(ja),L=F?"width":"height",U=Ta(b,{placement:x,boundary:m,rootBoundary:k,altBoundary:g,padding:h});E=F?
...
fn:function(a){var b=a.state,c=a.options;a=a.name;var d=c.mainAxis,e=void 0===d?!0:d;d=c.altAxis;d=void 0===d?!1:d;var f=c.tether;f=void 0===f?!0:f;var h=c.tetherOffset,m=void 0===h?0:h;c=Ta(b,{boundary:c.boundary,rootBoundary:c.rootBoundary,padding:c.padding,altBoundary:c.altBoundary});h=B(b.placement);var k=b.placement.split("-")[1],g=!k,l=Pa(h);h="x"===l?"y":"x";var n=b.modifiersData.popperOffsets,q=b.rects.reference,r=b.rects.popper,p="function"===typeof m?m(Object.assign(Object.assign({},b.rects),
{},{placement:b.placement})):m;m={x:0,y:0};if(n){if(e){var v="y"===l?top:"left",H="y"===l?"bottom":"right",x="y"===l?"height":"width";e=n[l];var ja=n[l]+c[v],E=n[l]-c[H],F=f?-r[x]/2:0,L="start"===k?q[x]:r[x];k="start"===k?-r[x]:-q[x];r=b.elements.arrow;r=f&&r?wa(r):{width:0,height:0};var U=b.modifiersData["arrow#persistent"]?b.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0};v=U[v];H=U[H];r=Math.max(0,Math.min(q[x],r[x]));L=g?q[x]/2-F-r-v-p:L-r-v-p;g=g?-q[x]/2+F+r+H+p:k+r+
H+p;p=b.elements.arrow&&Ba(b.elements.arrow);q=b.modifiersData.offset?b.modifiersData.offset[b.placement][l]:0;p=n[l]+L-q-(p?"y"===l?p.clientTop||0:p.clientLeft||0:0);g=n[l]+g-q;f=Math.max(f?Math.min(ja,p):ja,Math.min(e,f?Math.max(E,g):E));n[l]=f;m[l]=f-e}d&&(d=n[h],f=Math.max(d+c["x"===l?top:"left"],Math.min(d,d-c["x"===l?"bottom":"right"])),n[h]=f,m[h]=f-d);b.modifiersData[a]=m}},requiresIfExists:["offset"]},{name:"arrow",enabled:!0,phase:"main",fn:function(a){var b,c=a.state;a=a.name;var d=c.elements.arrow,
e=c.modifiersData.popperOffsets,f=B(c.placement),h=Pa(f);f=0<=["left","right"].indexOf(f)?"height":"width";if(d&&e){var m=c.modifiersData[a+"#persistent"].padding,k=wa(d),g="y"===h?top:"left",l="y"===h?"bottom":"right",n=c.rects.reference[f]+c.rects.reference[h]-e[h]-c.rects.popper[f];e=e[h]-c.rects.reference[h];d=(d=Ba(d))?"y"===h?d.clientHeight||0:d.clientWidth||0:0;n=d/2-k[f]/2+(n/2-e/2);f=Math.max(m[g],Math.min(n,d-k[f]-m[l]));c.modifiersData[a]=(b={},b[h]=f,b.centerOffset=f-n,b)}},effect:function(a){var b=
...
function ib(){return[{name:"applyStyles",fn({state:a}){Object.keys(a.elements).forEach(b=>{if("popper"===b){var c=a.attributes[b]||{},d=a.elements[b];Object.assign(d.style,{position:"fixed",left:"50%",top:"50%",transform:"translate(-50%, -50%)"});Object.keys(c).forEach(a=>{let b=c[a];!1===b?d.removeAttribute(a):d.setAttribute(a,!0===b?"":b)})}})}},{name:"computeStyles",options:{adaptive:!1}}]}
function jb(a){let b=ib(),c={placement:"top",strategy:"fixed",modifiers:[{name:"focusAfterRender",enabled:!0,phase:"afterWrite",fn(){setTimeout(()=>{a.el&&a.el.focus()},300)}}]};return c=hb({},c,{modifiers:Array.from(new Set([...c.modifiers,...b]))})}function kb(a){return la(a)&&""!==a?"-"!==a.charAt(a.length-1)?`${a}-`:a:""}
function lb(a){a=a.options.attachTo||{};let b=Object.assign({},a);if(la(a.element)){try{b.element=document.querySelector(a.element)}catch(c){}b.element||console.error(`The element for this Shepherd step was not found ${a.element}`)}return b}function mb(){let a=Date.now();return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,b=>{let c=(a+16*Math.random())%16|0;a=Math.floor(a/16);return("x"==b?c:c&3|8).toString(16)})}
function nb(a,b){if(a.popperOptions){let c=Object.assign({},b,a.popperOptions);if(a.popperOptions.modifiers&&0<a.popperOptions.modifiers.length){let d=a.popperOptions.modifiers.map(a=>a.name);b=b.modifiers.filter(a=>!d.includes(a.name));c.modifiers=Array.from(new Set([...b,...a.popperOptions.modifiers]))}return c}return b}function C(){}function ob(a,b){for(let c in b)a[c]=b[c];return a}function D(a){return a()}function pb(a){return"function"===typeof a}
function G(a,b){return a!=a?b==b:a!==b||a&&"object"===typeof a||"function"===typeof a}function I(a){a.parentNode.removeChild(a)}function qb(a){return document.createElementNS("http://www.w3.org/2000/svg",a)}function rb(a,b,c,d){a.addEventListener(b,c,d);return()=>a.removeEventListener(b,c,d)}function J(a,b,c){null==c?a.removeAttribute(b):a.getAttribute(b)!==c&&a.setAttribute(b,c)}
function sb(a,b){let c=Object.getOwnPropertyDescriptors(a.__proto__);for(let d in b)null==b[d]?a.removeAttribute(d):"style"===d?a.style.cssText=b[d]:"__value"===d?a.value=a[d]=b[d]:c[d]&&c[d].set?a[d]=b[d]:J(a,d,b[d])}function K(a,b,c){a.classList[c?"add":"remove"](b)}let M;function tb(){if(!M)throw Error("Function called outside component initialization");return M}let ub=[],N=[],vb=[],wb=[],xb=Promise.resolve(),yb=!1;function zb(a){vb.push(a)}let Ab=!1,Bb=new Set;
function Cb(){if(!Ab){Ab=!0;do{for(var a=0;a<ub.length;a+=1){var b=ub[a];M=b;b=b.$$;if(null!==b.fragment){b.update();b.before_update.forEach(D);let a=b.dirty;b.dirty=[-1];b.fragment&&b.fragment.p(b.ctx,a);b.after_update.forEach(zb)}}for(ub.length=0;N.length;)N.pop()();for(a=0;a<vb.length;a+=1)b=vb[a],Bb.has(b)||(Bb.add(b),b());vb.length=0}while(ub.length);for(;wb.length;)wb.pop()();Ab=yb=!1;Bb.clear()}}let Db=new Set,O;function P(){O={r:0,c:[],p:O}}function Q(){O.r||O.c.forEach(D);O=O.p}
function R(a,b){a&&a.i&&(Db.delete(a),a.i(b))}function S(a,b,c,d){a&&a.o&&!Db.has(a)&&(Db.add(a),O.c.push(()=>{Db.delete(a);d&&(c&&a.d(1),d())}),a.o(b))}function T(a){a&&a.c()}function V(a,b,c){let {fragment:d,on_mount:e,on_destroy:f,after_update:h}=a.$$;d&&d.m(b,c);zb(()=>{let b=e.map(D).filter(pb);f?f.push(...b):b.forEach(D);a.$$.on_mount=[]});h.forEach(zb)}function W(a,b){a=a.$$;null!==a.fragment&&(a.on_destroy.forEach(D),a.fragment&&a.fragment.d(b),a.on_destroy=a.fragment=null,a.ctx=[])}
function X(a,b,c,d,e,f,h=[-1]){let m=M;M=a;let k=b.props||{},g=a.$$={fragment:null,ctx:null,props:f,update:C,not_equal:e,bound:Object.create(null),on_mount:[],on_destroy:[],before_update:[],after_update:[],context:new Map(m?m.$$.context:[]),callbacks:Object.create(null),dirty:h,skip_bound:!1},l=!1;g.ctx=c?c(a,k,(b,c,...d)=>{d=d.length?d[0]:c;if(g.ctx&&e(g.ctx[b],g.ctx[b]=d)){if(!g.skip_bound&&g.bound[b])g.bound[b](d);l&&(-1===a.$$.dirty[0]&&(ub.push(a),yb||(yb=!0,xb.then(Cb)),a.$$.dirty.fill(0)),
a.$$.dirty[b/31|0]|=1<<b%31)}return c}):[];g.update();l=!0;g.before_update.forEach(D);g.fragment=d?d(g.ctx):!1;b.target&&(b.hydrate?(c=Array.from(b.target.childNodes),g.fragment&&g.fragment.l(c),c.forEach(I)):g.fragment&&g.fragment.c(),b.intro&&R(a.$$.fragment),V(a,b.target,b.anchor),Cb());M=m}
...
function Eb(a){let b,c,d,e,f;return{c(){b=document.createElement("button");J(b,"aria-label",c=a[3]?a[3]:null);J(b,"class",d=`${a[1]||""} shepherd-button ${a[4]?"shepherd-button-secondary":""}`);b.disabled=a[2];J(b,"tabindex","0")},m(c,d){c.insertBefore(b,d||null);b.innerHTML=a[5];e||(f=rb(b,"click",function(){pb(a[0])&&a[0].apply(this,arguments)}),e=!0)},p(e,[f]){a=e;f&32&&(b.innerHTML=a[5]);f&8&&c!==(c=a[3]?a[3]:null)&&J(b,"aria-label",c);f&18&&d!==(d=`${a[1]||""} shepherd-button ${a[4]?"shepherd-button-secondary":
""}`)&&J(b,"class",d);f&4&&(b.disabled=a[2])},i:C,o:C,d(a){a&&I(b);e=!1;f()}}}function Fb(a,b,c){let {config:d}=b,{step:e}=b,f,h,m,k,g,l;a.$$set=a=>{"config"in a&&c(6,d=a.config);"step"in a&&c(7,e=a.step)};a.$$.update=()=>{if(a.$$.dirty&192){c(0,f=d.action?d.action.bind(e.tour):null);c(1,h=d.classes);if(d.disabled){var b=d.disabled;b=u(b)?b.call(e):b}else b=!1;c(2,m=b);c(3,k=d.label);c(4,g=d.secondary);c(5,l=d.text)}};return[f,h,m,k,g,l,d,e]}
class Gb extends Y{constructor(a){super();X(this,a,Fb,Eb,G,{config:6,step:7})}}function Hb(a,b,c){a=a.slice();a[2]=b[c];return a}
function Ib(a){let b,c,d=a[1],e=[];for(let b=0;b<d.length;b+=1)e[b]=Jb(Hb(a,d,b));let f=a=>S(e[a],1,1,()=>{e[a]=null});return{c(){for(let a=0;a<e.length;a+=1)e[a].c();b=document.createTextNode("")},m(a,d){for(let b=0;b<e.length;b+=1)e[b].m(a,d);a.insertBefore(b,d||null);c=!0},p(a,c){if(c&3){d=a[1];let h;for(h=0;h<d.length;h+=1){let f=Hb(a,d,h);e[h]?(e[h].p(f,c),R(e[h],1)):(e[h]=Jb(f),e[h].c(),R(e[h],1),e[h].m(b.parentNode,b))}P();for(h=d.length;h<e.length;h+=1)f(h);Q()}},i(){if(!c){for(let a=0;a<
d.length;a+=1)R(e[a]);c=!0}},o(){e=e.filter(Boolean);for(let a=0;a<e.length;a+=1)S(e[a]);c=!1},d(a){var c=e;for(let b=0;b<c.length;b+=1)c[b]&&c[b].d(a);a&&I(b)}}}function Jb(a){let b,c;b=new Gb({props:{config:a[2],step:a[0]}});return{c(){T(b.$$.fragment)},m(a,e){V(b,a,e);c=!0},p(a,c){let d={};c&2&&(d.config=a[2]);c&1&&(d.step=a[0]);b.$set(d)},i(a){c||(R(b.$$.fragment,a),c=!0)},o(a){S(b.$$.fragment,a);c=!1},d(a){W(b,a)}}}
function Kb(a){let b,c,d=a[1]&&Ib(a);return{c(){b=document.createElement("footer");d&&d.c();J(b,"class","shepherd-footer")},m(a,f){a.insertBefore(b,f||null);d&&d.m(b,null);c=!0},p(a,[c]){a[1]?d?(d.p(a,c),c&2&&R(d,1)):(d=Ib(a),d.c(),R(d,1),d.m(b,null)):d&&(P(),S(d,1,1,()=>{d=null}),Q())},i(){c||(R(d),c=!0)},o(){S(d);c=!1},d(a){a&&I(b);d&&d.d()}}}function Lb(a,b,c){let {step:d}=b;a.$$set=a=>{"step"in a&&c(0,d=a.step)};let e;a.$$.update=()=>{a.$$.dirty&1&&c(1,e=d.options.buttons)};return[d,e]}
class Mb extends Y{constructor(a){super();X(this,a,Lb,Kb,G,{step:0})}}
function Nb(a){let b,c,d,e,f;return{c(){b=document.createElement("button");c=document.createElement("span");c.textContent="\u00d7";J(c,"aria-hidden","true");J(b,"aria-label",d=a[0].label?a[0].label:"Close Tour");J(b,"class","shepherd-cancel-icon");J(b,"type","button")},m(d,m){d.insertBefore(b,m||null);b.appendChild(c);e||(f=rb(b,"click",a[1]),e=!0)},p(a,[c]){c&1&&d!==(d=a[0].label?a[0].label:"Close Tour")&&J(b,"aria-label",d)},i:C,o:C,d(a){a&&I(b);e=!1;f()}}}
function Ob(a,b,c){let {cancelIcon:d}=b,{step:e}=b;a.$$set=a=>{"cancelIcon"in a&&c(0,d=a.cancelIcon);"step"in a&&c(2,e=a.step)};return[d,a=>{a.preventDefault();e.cancel()},e]}class Pb extends Y{constructor(a){super();X(this,a,Ob,Nb,G,{cancelIcon:0,step:2})}}function Qb(a){let b;return{c(){b=document.createElement("h3");J(b,"id",a[1]);J(b,"class","shepherd-title")},m(c,d){c.insertBefore(b,d||null);a[3](b)},p(a,[d]){d&2&&J(b,"id",a[1])},i:C,o:C,d(c){c&&I(b);a[3](null)}}}
function Rb(a,b,c){let {labelId:d}=b,{element:e}=b,{title:f}=b;tb().$$.after_update.push(()=>{u(f)&&c(2,f=f());c(0,e.innerHTML=f,e)});a.$$set=a=>{"labelId"in a&&c(1,d=a.labelId);"element"in a&&c(0,e=a.element);"title"in a&&c(2,f=a.title)};return[e,d,f,function(a){N[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}class Sb extends Y{constructor(a){super();X(this,a,Rb,Qb,G,{labelId:1,element:0,title:2})}}
function Tb(a){let b,c;b=new Sb({props:{labelId:a[0],title:a[2]}});return{c(){T(b.$$.fragment)},m(a,e){V(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.labelId=a[0]);c&4&&(d.title=a[2]);b.$set(d)},i(a){c||(R(b.$$.fragment,a),c=!0)},o(a){S(b.$$.fragment,a);c=!1},d(a){W(b,a)}}}
function Ub(a){let b,c;b=new Pb({props:{cancelIcon:a[3],step:a[1]}});return{c(){T(b.$$.fragment)},m(a,e){V(b,a,e);c=!0},p(a,c){let d={};c&8&&(d.cancelIcon=a[3]);c&2&&(d.step=a[1]);b.$set(d)},i(a){c||(R(b.$$.fragment,a),c=!0)},o(a){S(b.$$.fragment,a);c=!1},d(a){W(b,a)}}}
function Vb(a){let b,c,d,e=a[2]&&Tb(a),f=a[3]&&a[3].enabled&&Ub(a);return{c(){b=document.createElement("header");e&&e.c();c=document.createTextNode(" ");f&&f.c();J(b,"class","shepherd-header")},m(a,m){a.insertBefore(b,m||null);e&&e.m(b,null);b.appendChild(c);f&&f.m(b,null);d=!0},p(a,[d]){a[2]?e?(e.p(a,d),d&4&&R(e,1)):(e=Tb(a),e.c(),R(e,1),e.m(b,c)):e&&(P(),S(e,1,1,()=>{e=null}),Q());a[3]&&a[3].enabled?f?(f.p(a,d),d&8&&R(f,1)):(f=Ub(a),f.c(),R(f,1),f.m(b,null)):f&&(P(),S(f,1,1,()=>{f=null}),Q())},
i(){d||(R(e),R(f),d=!0)},o(){S(e);S(f);d=!1},d(a){a&&I(b);e&&e.d();f&&f.d()}}}function Wb(a,b,c){let {labelId:d}=b,{step:e}=b,f,h;a.$$set=a=>{"labelId"in a&&c(0,d=a.labelId);"step"in a&&c(1,e=a.step)};a.$$.update=()=>{a.$$.dirty&2&&(c(2,f=e.options.title),c(3,h=e.options.cancelIcon))};return[d,e,f,h]}class Xb extends Y{constructor(a){super();X(this,a,Wb,Vb,G,{labelId:0,step:1})}}
function Yb(a){let b;return{c(){b=document.createElement("div");J(b,"class","shepherd-text");J(b,"id",a[1])},m(c,d){c.insertBefore(b,d||null);a[3](b)},p(a,[d]){d&2&&J(b,"id",a[1])},i:C,o:C,d(c){c&&I(b);a[3](null)}}}
function Zb(a,b,c){let {descriptionId:d}=b,{element:e}=b,{step:f}=b;tb().$$.after_update.push(()=>{let {text:a}=f.options;u(a)&&(a=a.call(f));a instanceof HTMLElement?e.appendChild(a):c(0,e.innerHTML=a,e)});a.$$set=a=>{"descriptionId"in a&&c(1,d=a.descriptionId);"element"in a&&c(0,e=a.element);"step"in a&&c(2,f=a.step)};return[e,d,f,function(a){N[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}class $b extends Y{constructor(a){super();X(this,a,Zb,Yb,G,{descriptionId:1,element:0,step:2})}}
function ac(a){let b,c;b=new Xb({props:{labelId:a[1],step:a[2]}});return{c(){T(b.$$.fragment)},m(a,e){V(b,a,e);c=!0},p(a,c){let d={};c&2&&(d.labelId=a[1]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(R(b.$$.fragment,a),c=!0)},o(a){S(b.$$.fragment,a);c=!1},d(a){W(b,a)}}}
function bc(a){let b,c;b=new $b({props:{descriptionId:a[0],step:a[2]}});return{c(){T(b.$$.fragment)},m(a,e){V(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.descriptionId=a[0]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(R(b.$$.fragment,a),c=!0)},o(a){S(b.$$.fragment,a);c=!1},d(a){W(b,a)}}}
function cc(a){let b,c;b=new Mb({props:{step:a[2]}});return{c(){T(b.$$.fragment)},m(a,e){V(b,a,e);c=!0},p(a,c){let d={};c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(R(b.$$.fragment,a),c=!0)},o(a){S(b.$$.fragment,a);c=!1},d(a){W(b,a)}}}
function dc(a){let b,c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled,d,e=void 0!==a[2].options.text,f,h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length,m,k=c&&ac(a),g=e&&bc(a),l=h&&cc(a);return{c(){b=document.createElement("div");k&&k.c();d=document.createTextNode(" ");g&&g.c();f=document.createTextNode(" ");l&&l.c();J(b,"class","shepherd-content")},m(a,c){a.insertBefore(b,c||null);k&&k.m(b,null);b.appendChild(d);g&&g.m(b,null);b.appendChild(f);
l&&l.m(b,null);m=!0},p(a,[m]){m&4&&(c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled);c?k?(k.p(a,m),m&4&&R(k,1)):(k=ac(a),k.c(),R(k,1),k.m(b,d)):k&&(P(),S(k,1,1,()=>{k=null}),Q());m&4&&(e=void 0!==a[2].options.text);e?g?(g.p(a,m),m&4&&R(g,1)):(g=bc(a),g.c(),R(g,1),g.m(b,f)):g&&(P(),S(g,1,1,()=>{g=null}),Q());m&4&&(h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length);h?l?(l.p(a,m),m&4&&R(l,1)):(l=cc(a),l.c(),R(l,1),l.m(b,null)):l&&(P(),S(l,1,1,
()=>{l=null}),Q())},i(){m||(R(k),R(g),R(l),m=!0)},o(){S(k);S(g);S(l);m=!1},d(a){a&&I(b);k&&k.d();g&&g.d();l&&l.d()}}}function ec(a,b,c){let {descriptionId:d}=b,{labelId:e}=b,{step:f}=b;a.$$set=a=>{"descriptionId"in a&&c(0,d=a.descriptionId);"labelId"in a&&c(1,e=a.labelId);"step"in a&&c(2,f=a.step)};return[d,e,f]}class fc extends Y{constructor(a){super();X(this,a,ec,dc,G,{descriptionId:0,labelId:1,step:2})}}
function gc(){let a;return{c(){a=document.createElement("div");J(a,"class","shepherd-arrow");J(a,"data-popper-arrow","")},m(b,c){b.insertBefore(a,c||null)},d(b){b&&I(a)}}}
function hc(a){let b,c,d,e,f,h,m,k,g=a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&a[4].options.attachTo.on&&gc();d=new fc({props:{descriptionId:a[2],labelId:a[3],step:a[4]}});let l=[{"aria-describedby":e=void 0!==a[4].options.text?a[2]:null},{"aria-labelledby":f=a[4].options.title?a[3]:null},a[1],{role:"dialog"},{tabindex:"0"}],n={};for(let a=0;a<l.length;a+=1)n=ob(n,l[a]);return{c(){b=document.createElement("div");g&&g.c();c=document.createTextNode(" ");T(d.$$.fragment);
sb(b,n);K(b,"shepherd-has-cancel-icon",a[5]);K(b,"shepherd-has-title",a[6]);K(b,"shepherd-element",!0)},m(e,f){e.insertBefore(b,f||null);g&&g.m(b,null);b.appendChild(c);V(d,b,null);a[13](b);h=!0;m||(k=rb(b,"keydown",a[7]),m=!0)},p(a,[k]){a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&a[4].options.attachTo.on?g||(g=gc(),g.c(),g.m(b,c)):g&&(g.d(1),g=null);var p={};k&4&&(p.descriptionId=a[2]);k&8&&(p.labelId=a[3]);k&16&&(p.step=a[4]);d.$set(p);p=b;{k=[(!h||k&20&&e!==(e=void 0!==
a[4].options.text?a[2]:null))&&{"aria-describedby":e},(!h||k&24&&f!==(f=a[4].options.title?a[3]:null))&&{"aria-labelledby":f},k&2&&a[1],{role:"dialog"},{tabindex:"0"}];let b={},c={},d={$$scope:1},p=l.length;for(;p--;){let a=l[p],e=k[p];if(e){for(v in a)v in e||(c[v]=1);for(let a in e)d[a]||(b[a]=e[a],d[a]=1);l[p]=e}else for(let b in a)d[b]=1}for(let a in c)a in b||(b[a]=void 0);var v=b}sb(p,n=v);K(b,"shepherd-has-cancel-icon",a[5]);K(b,"shepherd-has-title",a[6]);K(b,"shepherd-element",!0)},i(a){h||
(R(d.$$.fragment,a),h=!0)},o(a){S(d.$$.fragment,a);h=!1},d(c){c&&I(b);g&&g.d();W(d);a[13](null);m=!1;k()}}}function ic(a){return a.split(" ").filter(a=>!!a.length)}
function jc(a,b,c){let {classPrefix:d}=b,{element:e}=b,{descriptionId:f}=b,{firstFocusableElement:h}=b,{focusableElements:m}=b,{labelId:k}=b,{lastFocusableElement:g}=b,{step:l}=b,{dataStepId:n}=b,q,r,p;tb().$$.on_mount.push(()=>{c(1,n={[`data-${d}shepherd-step-id`]:l.id});c(9,m=e.querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]'));c(8,h=m[0]);c(10,g=m[m.length-1])});tb().$$.after_update.push(()=>
{if(p!==l.options.classes){var a=p;la(a)&&(a=ic(a),a.length&&e.classList.remove(...a));a=p=l.options.classes;la(a)&&(a=ic(a),a.length&&e.classList.add(...a))}});a.$$set=a=>{"classPrefix"in a&&c(11,d=a.classPrefix);"element"in a&&c(0,e=a.element);"descriptionId"in a&&c(2,f=a.descriptionId);"firstFocusableElement"in a&&c(8,h=a.firstFocusableElement);"focusableElements"in a&&c(9,m=a.focusableElements);"labelId"in a&&c(3,k=a.labelId);"lastFocusableElement"in a&&c(10,g=a.lastFocusableElement);"step"in
...
break;case 27:b.options.exitOnEsc&&l.cancel();break;case 37:b.options.keyboardNavigation&&b.back();break;case 39:b.options.keyboardNavigation&&b.next()}},h,m,g,d,()=>e,function(a){N[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}class kc extends Y{constructor(a){super();X(this,a,jc,hc,G,{classPrefix:11,element:0,descriptionId:2,firstFocusableElement:8,focusableElements:9,labelId:3,lastFocusableElement:10,step:4,dataStepId:1,getElement:12})}get getElement(){return this.$$.ctx[12]}}var lc=void 0;
...
g.body?(m.call(this,a,a.scrollLeft+d.left-b.left,a.scrollTop+d.top-b.top),"fixed"!==k.getComputedStyle(a).position&&k.scrollBy({left:b.left,top:b.top,behavior:"smooth"})):k.scrollBy({left:d.left,top:d.top,behavior:"smooth"})}}}}}})()}(lc,lc.exports),lc.exports).polyfill();
class mc extends ma{constructor(a,b={}){super(a,b);this.tour=a;this.classPrefix=this.tour.options?kb(this.tour.options.classPrefix):"";this.styles=a.styles;na(this);this._setOptions(b);return this}cancel(){this.tour.cancel();this.trigger("cancel")}complete(){this.tour.complete();this.trigger("complete")}destroy(){this.tooltip&&(this.tooltip.destroy(),this.tooltip=null);this.el instanceof HTMLElement&&this.el.parentNode&&(this.el.parentNode.removeChild(this.el),this.el=null);this._updateStepTargetOnHide();
...
this.shepherdElementComponent.$set({step:this})}getElement(){return this.el}getTarget(){return this.target}_createTooltipContent(){this.shepherdElementComponent=new kc({target:document.body,props:{classPrefix:this.classPrefix,descriptionId:`${this.id}-description`,labelId:`${this.id}-label`,step:this,styles:this.styles}});return this.shepherdElementComponent.getElement()}_scrollTo(a){let {element:b}=lb(this);u(this.options.scrollToHandler)?this.options.scrollToHandler(b):b instanceof Element&&"function"===
...
this.id=this.options.id||`step-${mb()}`;c&&Object.keys(c).forEach(a=>{this.on(a,c[a],this)})}_setupElements(){void 0!==this.el&&this.destroy();this.el=this._createTooltipContent();this.options.advanceOn&&pa(this);{this.tooltip&&this.tooltip.destroy();let c=lb(this),d=c.element;var a=c;var b={modifiers:[{name:"preventOverflow",options:{altAxis:!0}}],strategy:"absolute"};this.isCentered()?b=jb(this):b.placement=a.on;(a=this.tour&&this.tour.options&&this.tour.options.defaultStepOptions)&&(b=nb(a,b));
b=nb(this.options,b);this.isCentered()&&(d=document.body,this.shepherdElementComponent.getElement().classList.add("shepherd-centered"));this.tooltip=gb(d,this.el,b);this.target=c.element}}_show(){this.trigger("before-show");this._setupElements();this.tour.modal||this.tour._setupModal();this.tour.modal.setupForStep(this);this._styleTargetElementForStep(this);this.el.hidden=!1;this.options.scrollTo&&setTimeout(()=>{this._scrollTo(this.options.scrollTo)});this.el.hidden=!1;let a=this.shepherdElementComponent.getElement(),
...
a.classList.remove(`${this.classPrefix}shepherd-enabled`,`${this.classPrefix}shepherd-target`)}}function nc(a){a&&({steps:a}=a,a.forEach(a=>{a.options&&!1===a.options.canClickTarget&&a.options.attachTo&&a.target instanceof HTMLElement&&a.target.classList.remove("shepherd-target-click-disabled")}))}function oc({width:a,height:b,x:c=0,y:d=0,r:e=0}){let {innerWidth:f,innerHeight:h}=window;return`M${f},${h}\
H0\
V0\
H${f}\
V${h}\
...
V${d+e}\
a${e},${e},0,0,0-${e}-${e}\
Z`}function pc(a){let b,c,d,e,f;return{c(){b=qb("svg");c=qb("path");J(c,"d",a[2]);J(b,"class",d=`${a[1]?"shepherd-modal-is-visible":""} shepherd-modal-overlay-container`)},m(d,m){d.insertBefore(b,m||null);b.appendChild(c);a[11](b);e||(f=rb(b,"touchmove",a[3]),e=!0)},p(a,[e]){e&4&&J(c,"d",a[2]);e&2&&d!==(d=`${a[1]?"shepherd-modal-is-visible":""} shepherd-modal-overlay-container`)&&J(b,"class",d)},i:C,o:C,d(c){c&&I(b);a[11](null);e=!1;f()}}}
function qc(a){if(!a)return null;let b=a instanceof HTMLElement&&window.getComputedStyle(a).overflowY;return"hidden"!==b&&"visible"!==b&&a.scrollHeight>=a.clientHeight?a:qc(a.parentElement)}
function rc(a,b,c){function d(){c(4,l={width:0,height:0,x:0,y:0,r:0})}function e(){c(1,n=!1);m()}function f(a,b,d=0,e=0){if(a.getBoundingClientRect){var f=a.getBoundingClientRect();var g=f.y||f.top;f=f.bottom||g+f.height;if(b){var h=b.getBoundingClientRect();b=h.y||h.top;h=h.bottom||b+h.height;g=Math.max(g,b);f=Math.min(f,h)}g={y:g,height:Math.max(f-g,0)};let {y:k,height:m}=g,{x:n,width:v,left:p}=a.getBoundingClientRect();c(4,l={width:v+2*d,height:m+2*d,x:(n||p)-d,y:k-d,r:e})}}function h(){c(1,n=
!0)}function m(){q&&(cancelAnimationFrame(q),q=void 0);window.removeEventListener("touchmove",p,{passive:!1})}function k(a){let {modalOverlayOpeningPadding:b,modalOverlayOpeningRadius:c}=a.options;if(a.target){let d=qc(a.target),e=()=>{q=void 0;f(a.target,d,b,c);q=requestAnimationFrame(e)};e();window.addEventListener("touchmove",p,{passive:!1})}else d()}let {element:g}=b,{openingProperties:l}=b;mb();let n=!1,q=void 0,r;d();let p=a=>{a.preventDefault()};a.$$set=a=>{"element"in a&&c(0,g=a.element);
"openingProperties"in a&&c(4,l=a.openingProperties)};a.$$.update=()=>{a.$$.dirty&16&&c(2,r=oc(l))};return[g,n,r,a=>{a.stopPropagation()},l,()=>g,d,e,f,function(a){m();a.tour.options.useModalOverlay?(k(a),h()):e()},h,function(a){N[a?"unshift":"push"](()=>{g=a;c(0,g)})}]}
class sc extends Y{constructor(a){super();X(this,a,rc,pc,G,{element:0,openingProperties:4,getElement:5,closeModalOpening:6,hide:7,positionModalOpening:8,setupForStep:9,show:10})}get getElement(){return this.$$.ctx[5]}get closeModalOpening(){return this.$$.ctx[6]}get hide(){return this.$$.ctx[7]}get positionModalOpening(){return this.$$.ctx[8]}get setupForStep(){return this.$$.ctx[9]}get show(){return this.$$.ctx[10]}}let Z=new ma;
class tc extends ma{constructor(a={}){super(a);na(this);this.options=Object.assign({},{exitOnEsc:!0,keyboardNavigation:!0},a);this.classPrefix=kb(this.options.classPrefix);this.steps=[];this.addSteps(this.options.steps);"active cancel complete inactive show start".split(" ").map(a=>{(a=>{this.on(a,b=>{b=b||{};b.tour=this;Z.trigger(a,b)})})(a)});this._setTourID();return this}addStep(a,b){a instanceof mc?a.tour=this:a=new mc(this,a);void 0!==b?this.steps.splice(b,0,a):this.steps.push(a);return a}addSteps(a){Array.isArray(a)&&
a.forEach(a=>{this.addStep(a)});return this}back(){let a=this.steps.indexOf(this.currentStep);this.show(a-1,!1)}cancel(){this.options.confirmCancel?window.confirm(this.options.confirmCancelMessage||"Are you sure you want to stop the tour?")&&this._done("cancel"):this._done("cancel")}complete(){this._done("complete")}getById(a){return this.steps.find(b=>b.id===a)}getCurrentStep(){return this.currentStep}hide(){let a=this.getCurrentStep();if(a)return a.hide()}isActive(){return Z.activeTour===this}next(){let a=
this.steps.indexOf(this.currentStep);a===this.steps.length-1?this.complete():this.show(a+1,!0)}removeStep(a){let b=this.getCurrentStep();this.steps.some((b,d)=>{if(b.id===a)return b.isOpen()&&b.hide(),b.destroy(),this.steps.splice(d,1),!0});b&&b.id===a&&(this.currentStep=void 0,this.steps.length?this.show(0):this.cancel())}show(a=0,b=!0){if(a=la(a)?this.getById(a):this.steps[a])this._updateStateBeforeShow(),u(a.options.showOn)&&!a.options.showOn()?this._skipStep(a,b):(this.trigger("show",{step:a,
previous:this.currentStep}),this.currentStep=a,a.show())}start(){this.trigger("start");this.focusedElBeforeOpen=document.activeElement;this.currentStep=null;this._setupModal();this._setupActiveTour();this.next()}_done(a){let b=this.steps.indexOf(this.currentStep);Array.isArray(this.steps)&&this.steps.forEach(a=>a.destroy());nc(this);this.trigger(a,{index:b});Z.activeTour=null;this.trigger("inactive",{tour:this});this.modal&&this.modal.hide();"cancel"!==a&&"complete"!==a||!this.modal||(a=document.querySelector(".shepherd-modal-overlay-container"))&&
a.remove();this.focusedElBeforeOpen instanceof HTMLElement&&this.focusedElBeforeOpen.focus()}_setupActiveTour(){this.trigger("active",{tour:this});Z.activeTour=this}_setupModal(){this.modal=new sc({target:this.options.modalContainer||document.body,props:{classPrefix:this.classPrefix,styles:this.styles}})}_skipStep(a,b){a=this.steps.indexOf(a);this.show(b?a+1:a-1,b)}_updateStateBeforeShow(){this.currentStep&&this.currentStep.hide();this.isActive()||this._setupActiveTour()}_setTourID(){this.id=`${this.options.tourName||
"tour"}--${mb()}`}}Object.assign(Z,{Tour:tc,Step:mc});export default Z
